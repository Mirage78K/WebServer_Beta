...
int main(void)
{
  ...
  xTaskCreate(webUser_taskHandler_webServer, "Task WebServer", 8192, NULL, tskIDLE_PRIORITY, &WebServer_TaskHandler);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : SD_DTC_Pin */
  GPIO_InitStruct.Pin = SD_DTC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SD_DTC_GPIO_Port, &GPIO_InitStruct);
